...
const int buzzerPin = 6;// Passive Buzzer SIG 
...
void loop()
{
  ...
  if(val == LOW)
  {
    ...
    tone(buzzerPin,320,200);//generate a tone on pin 7 ,with a frequency of 320hz and the    duration of the tone is 200 milliseconds
  }
